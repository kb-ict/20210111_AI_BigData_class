...
public class Selertinout {
	public static void selectinoutDo(){
		...
		PreparedStatement pstm = null;
		 ...
		 try{
			 ...
			 CallableStatement cs = conn.prepareCall("begin selecteinout_STUTBL(?); end;");
			 System.out.println("출력하고자 하는 학생 학번을 입력하세요.");
