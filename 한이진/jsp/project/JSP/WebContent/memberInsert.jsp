	...
	<div class="jumbotron" align="center">
		...
		<form action="./check/insertMember.jsp" class = 'col-5'>
		  ...
		  <div class="form-group">
		    ...
		    <input type = "text" class="form-control float-left mt-2 col-9" id = "inputId" name = "ID" required="required" placeholder="아이디를 입력하세요.">
		    <input type = "button" class= "float-left mt-2 btn btn-success col-3" value="아이디 확인" id= "idcheck" name = "idcheck"><br>
		  ...
		  <div>
		    <label for="chpwd" class="float-left mt-2">비밀번호 확인:</label>
		    <input type="password" class="form-control mt-2" id="inputPwd2" placeholder="비밀번호를  재입력하세요.">
		    <div id="pw_check"></div>
		  </div>
		  <div class="form-group">
		  <label for="phone" class="float-left mt-2">전화번호:</label>
		  <input type="text" class="form-control mt-2" id="inputPhone" name = "PHONE" placeholder="비밀번호를 입력하세요.">
		  </div>
