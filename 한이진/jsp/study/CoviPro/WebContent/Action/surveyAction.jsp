...
<body>
	<%
		...
		if( answer1 == null || answer2 == null){
			...
			switch(answer1){
				case "answer1":
					sql="INSERT INTO `covibbs`.`question1` (`answer1`) VALUES (?)";
					result = surveyDao.Submit(answer1, sql);
					break;
				case "answer2":
					sql="INSERT INTO `covibbs`.`question1` (`answer2`) VALUES (?)";
					result = surveyDao.Submit(answer1, sql);
					break;
				case "answer3":
					sql="INSERT INTO `covibbs`.`question1` (`answer3`) VALUES (?)";
					result = surveyDao.Submit(answer1, sql);
					break;
				case "answer4":
					sql="INSERT INTO `covibbs`.`question1` (`answer4`) VALUES (?)";
					result = surveyDao.Submit(answer1, sql);
					break;
				case "answer5":
					sql="INSERT INTO `covibbs`.`question1` (`answer5`) VALUES (?)";
					result = surveyDao.Submit(answer1, sql);
					break;
			}
			switch(answer2){
				case "answer1":
					sql="INSERT INTO `covibbs`.`question2` (`answer1`) VALUES (?)";
					result = surveyDao.Submit(answer2, sql);
					break;
				case "answer2":
					sql="INSERT INTO `covibbs`.`question2` (`answer2`) VALUES (?)";
					result = surveyDao.Submit(answer2, sql);
					break;
				case "answer3":
					sql="INSERT INTO `covibbs`.`question2` (`answer3`) VALUES (?)";
					result = surveyDao.Submit(answer2, sql);
					break;
				case "answer4":
					sql="INSERT INTO `covibbs`.`question2` (`answer4`) VALUES (?)";
					result = surveyDao.Submit(answer2, sql);
					break;
				case "answer5":
					sql="INSERT INTO `covibbs`.`question2` (`answer5`) VALUES (?)";
					result = surveyDao.Submit(answer2, sql);
					break;
			}
			if(result == -1){
