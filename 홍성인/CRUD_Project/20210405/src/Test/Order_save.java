...
//  	String path = "D:\\java\\"+format2+""; //폴더 경로
  		File Folder = new File("C:\\Users\\donqu\\OneDrive\\바탕 화면\\영수증\\"+format_time2);
  		System.out.println("C:\\Users\\donqu\\OneDrive\\바탕 화면\\영수증\\"+format_time2+"");
    	...
    	FileWriter fw = new FileWriter("C:\\Users\\donqu\\OneDrive\\바탕 화면\\영수증\\"+format_time2+"\\"+format_time1+".txt"); // 절대주소 경로 가능
