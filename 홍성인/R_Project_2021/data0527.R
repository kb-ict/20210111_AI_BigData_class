...
#useNIADic()
useSejongDic()
wordData <- readLines("D:/20210111_AI_BigData_class/홍성인/R_Project_2021/res/애국가(가사).txt")
wordData

wordData2 <- sapply(wordData, extractNoun)
wordData2

addWords <- c("동해물","삼천리","화려강산","대한사람","백두산")
# 사용자 사전에 사용자 정의 단어 추가가
...
wordcloud2(wordTable2,fontFamily = "맑은 고딕",size=1.0,color="random-light",
           backgroundColor="black",shape="star")
#===============================================================================
library(tm)
facebook <- file("D:/20210111_AI_BigData_class/홍성인/R_Project_2021/res/facebook_bigdata.txt",
                 encoding="UTF-8")
